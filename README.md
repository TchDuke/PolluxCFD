...
![Centrifugal impeller in a volute casing: Mach number in the mid-plane slice](docs/images/volute_3d.png)

**Рабочее колесо в спиральном корпусе (улитке)**, 13000 об/мин, число Маха в
срезе по середине колеса. Видны спираль корпуса и выходной канал. Пример
`cases3d/volute.cfd3d`, 912 тысяч ячеек, счёт на видеокарте.
